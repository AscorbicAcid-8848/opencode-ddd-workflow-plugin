...
4. Run declared verification. Use normal project setup within host permissions. Report a runtime block when prerequisites cannot safely be restored; never invent evidence. Read and test as much as the approved slice requires; call counts do not define completion.
