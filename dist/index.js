...
import { initialize, prepare, submit, review, status, archive, openspec } from "./engine.js";
...
async function resolveActiveIdentity(ctx, workflowType, workflowId) {
    ...
    if (workflowType && workflowId)
        return { workflowType, workflowId, projectRoot: root };
                ...
                async execute(args, context) {
                    try {
                        ...
                        if (args.action === "review") {
                            ...
                            return out(await review({ ...id, stage: i.stage, decision: i.decision, reviewer: i.reviewer, feedback: i.feedback }));
                        }
